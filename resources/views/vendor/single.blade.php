    ...
    <div class="row medium-padding120">
        <main class="main">
            <div class="col-lg-10 col-lg-offset-1">
                        ...
                        <div class="post-additional-info">
                            ...
                            <div class="post__author author vcard">
                                ...
                                <div class="post__author-name fn">
                                    <a href="#" class="post__author-link">{{ $name }}</a>
                                </div>
                ...
                <a href="{{ route('single.post', ['id'=>$prev_post->id, 'slug'=>$prev_post->slug]) }}" class="btn-prev-wrap">
                        <svg class="btn-prev">
                  ...
                  @endif
                  @if($next_post)
                    <a href="{{ route('single.post', ['id'=>$next_post->id, 'slug'=>$next_post->slug]) }}" class="btn-next-wrap">
                        <div class="btn-content">
